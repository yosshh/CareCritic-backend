...
import { createHospital, getHospitalById, getHospitals, loginHospitals, logoutHospital, updateHospital } from "../controllers/hospital.controller.js";
...
router.route('/getHospital/:id').get(verifyJWT, getHospitalById)
